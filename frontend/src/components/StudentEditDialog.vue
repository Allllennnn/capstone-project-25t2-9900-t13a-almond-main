  ...
  >
    ...
    >
      ...
      <el-form-item label="Student No" prop="studentNo">
        <el-input v-model="form.studentNo" placeholder="Enter student number" />
      </el-form-item>
  ...
  setup(props, { emit }) {
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        let response
        if (props.isEdit) {
          response = await adminAPI.updateStudent(submitData)
        } else {
          response = await adminAPI.createStudent(submitData)
        }
